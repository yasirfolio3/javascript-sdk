...
import CachedHttpPollingDatafileManager from './cachedhttpPollingDatafileManager'
import { Headers, AbortableRequest } from './http';
import { DatafileManagerConfig } from './datafileManager';

export default class ReactNativeDatafileManager extends CachedHttpPollingDatafileManager {
